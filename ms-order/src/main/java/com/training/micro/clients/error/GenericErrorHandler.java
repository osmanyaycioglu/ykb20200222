...
public class GenericErrorHandler {
    ...
    public ErrorObject handleException(final RestException exp) {
        ErrorObject errorObject = new ErrorObject().setBoundedContext(this.boundedContext)
                                                   .setMicroservice(this.microservice)
                                                   .setErrorDesc("Error while calling other microservice")
                                                   .setCause(1000);

        errorObject.addSubError(exp.getErrorObject());
        return errorObject;
    }
